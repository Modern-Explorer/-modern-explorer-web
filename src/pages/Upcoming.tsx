...
const expeditions = [
  ...
  },
  {
    ...
    img: IMG('Nature', '20250510_124904-EDIT.webp'),
    duration: '5–7 days',
    difficulty: 'Strenuous',
    type: 'Multi-Day Expedition',
    icon: '⛰️',
  ...
  return (
    <main style={{ paddingTop: 72 }}>
      ...
      <section style={{ position: 'relative', padding: '90px 0 70px' }}>
        <div style={{ position: 'absolute', inset: 0, backgroundImage: `url('${IMG('Crestone', '20250810_095413-EDIT.webp')}')`, backgroundSize: 'cover', backgroundPosition: 'center 35%', filter: 'brightness(0.28)' }} />
            ...
            <div>
              <div style={{ position: 'relative', borderRadius: 8, overflow: 'hidden', border: '1px solid var(--border)', marginBottom: 20 }}>
                <div style={{ position: 'relative', paddingTop: '65%' }}>
                  <img src={IMG('Crestone', '20250810_090608-EDIT.webp')} alt="Crestone Walking Tour" loading="lazy" decoding="async" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        ...
        <div className="container">
          ...
          <div id="mesa-treasure" style={{ border: '1px solid rgba(203,243,110,0.2)', borderRadius: 8, overflow: 'hidden', marginBottom: 56, background: 'var(--bg-card)' }}>
            ...
            <div style={{ position: 'relative', paddingTop: '42%', overflow: 'hidden' }}>
              <img
                src="/assets/images/content/History/Spanish Map.webp"
